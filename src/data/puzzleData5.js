...
export const puzzleGrid5 = [
  // Row 0
  [
    { isBlock: false, acrossStart: 1, downStart: 1, letter: '' },    // '소'
    { isBlock: false, acrossStart: null, downStart: null, letter: '' }, // '방'
    { isBlock: false, acrossStart: null, downStart: 2, letter: '' },  // '차'
  ...
  [
    { isBlock: true, acrossStart: null, downStart: null, letter: '' },
    { isBlock: false, acrossStart: 4, downStart: 3, letter: '' },    // '머'
    { isBlock: false, acrossStart: null, downStart: null, letter: '' }, // '리'
    { isBlock: false, acrossStart: null, downStart: 4, letter: '' },  // '털'
    { isBlock: true, acrossStart: null, downStart: null, letter: '' }
  ],
  // Row 2
  [
    { isBlock: true, acrossStart: null, downStart: null, letter: '' },
    { isBlock: true, acrossStart: null, downStart: null, letter: '' },
    { isBlock: false, acrossStart: 6, downStart: 5, letter: '' },    // '유'
    { isBlock: false, acrossStart: null, downStart: null, letter: '' }, // '치'
    { isBlock: false, acrossStart: null, downStart: 6, letter: '' }   // '원'
  ],
  // Row 3
  [
    { isBlock: false, acrossStart: 8, downStart: 7, letter: '' },    // '문'
    { isBlock: false, acrossStart: null, downStart: 8, letter: '' },  // '병'
    { isBlock: true, acrossStart: null, downStart: null, letter: '' },
    { isBlock: false, acrossStart: 10, downStart: null, letter: '' }, // '이'
    { isBlock: false, acrossStart: null, downStart: null, letter: '' }  // '사'
  ],
  // Row 4
  [
    { isBlock: false, acrossStart: 11, downStart: null, letter: '' }, // '나'
    { isBlock: false, acrossStart: null, downStart: null, letter: '' }, // '란'
    { isBlock: false, acrossStart: null, downStart: 9, letter: '' },  // '히'
    { isBlock: true, acrossStart: null, downStart: null, letter: '' },
    { isBlock: true, acrossStart: null, downStart: null, letter: '' }
  ]
];
